...
class conv_421(nn.Module):
	...
	def __init__(self, C_in, C_out, bias):
		...
		self.op = nn.Conv3d(in_channels=C_in, out_channels=C_out, kernel_size=4, stride=2, padding=1, bias=bias)
...
class conv_622(nn.Module):
	...
	def __init__(self, C_in, C_out, bias):
		...
		self.op = nn.Conv3d(in_channels=C_in, out_channels=C_out, kernel_size=6, stride=2, padding=2, bias=bias)
...
class conv_823(nn.Module):
	...
	def __init__(self, C_in, C_out, bias):
		...
		self.op = nn.Conv3d(in_channels=C_in, out_channels=C_out, kernel_size=8, stride=2, padding=3, bias=bias)
