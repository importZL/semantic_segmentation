...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='pix2pix', help='chooses which model to use. [pix2pix | pix2pix3d]')
        ...
        parser.add_argument('--preprocess', type=str, default='take_center_and_crop',
                            help='scaling and cropping of images at load time [resize_and_crop | pad_and_crop | take_center_and_crop | pad | take_center | crop | scale_width | scale_width_and_crop | none]')
