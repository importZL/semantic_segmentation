...
save_path = './checkpoint_ablation/'+str(opt.seg_model)+'-ISIC-200-'+str(opt.aug_type)+time.strftime("%Y%m%d-%H%M%S")
if not os.path.exists(save_path):
    os.mkdir(save_path) 
unet_save_path = save_path+'/unet.pkl'  

##### Initialize logging #####
logger = wandb.init(project='ISIC_ablation', name="ISIC-200-"+str(opt.aug_type), resume='allow', anonymous='must')
...
model_path = './pix2pix_model/20230315-055526-pix2pix-UNet-200' #'./pix2pix_model/20230314-210809-pix2pix-UNet-40' './pix2pix_model/20230320-194227-pix2pix-UNet-100' # 
