...
save_path = './pix2pix_breast_model/'+time.strftime("%Y%m%d-%H%M%S"+'-pix2pix-breast-100')
if not os.path.exists(save_path):
    os.mkdir(save_path) 

##### Initialize logging #####
logger = wandb.init(project='pix2pix_train', name="Breast-100", resume='allow', anonymous='must')
