...
save_path = './checkpoint_lung_new/'+'UNet_JSRT-100-'+time.strftime("%Y%m%d-%H%M%S")
...
logger = wandb.init(project='vanilla-unet', name="unet-JSRT-100", resume='allow', anonymous='must')
