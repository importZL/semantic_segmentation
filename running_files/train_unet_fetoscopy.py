...
save_path = './checkpoint_breast/'+str(opt.seg_model)+'_fetoscopy-100-'+time.strftime("%Y%m%d-%H%M%S")
...
logger = wandb.init(project='vanilla-unet', name=str(opt.seg_model)+"-fetoscopy-100", resume='allow', anonymous='must')
