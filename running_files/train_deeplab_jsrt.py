...
save_path = './checkpoint_lung_new/'+'DeepLab_JSRT-100-'+time.strftime("%Y%m%d-%H%M%S")
...
logger = wandb.init(project='vanilla-deeplab', name="deeplab-JSRT-100", resume='allow', anonymous='must')
