...
save_path = './pix2pix_model/'+time.strftime("%Y%m%d-%H%M%S"+'-pix2pix-fetoscopy-100')
if not os.path.exists(save_path):
    os.mkdir(save_path) 

##### Initialize logging #####
# logger = wandb.init(project='end2end-unet-ISIC', name="unet-200", resume='allow', anonymous='must')
logger = wandb.init(project='pix2pix_train', name="fetoscopy-100", resume='allow', anonymous='must')
