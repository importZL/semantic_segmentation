...
save_path = './checkpoint_breast/'+'end2end-100-'+str(opt.seg_model)+'-'+str(opt.loss_lambda)+'-'+time.strftime("%Y%m%d-%H%M%S")
...
logger = wandb.init(project='end2end-Breast', name=str(opt.seg_model)+"-100-"+str(opt.loss_lambda), resume='allow', anonymous='must')
...
model_path = './pix2pix_breast_model/20230413-063933-pix2pix-breast-100'
