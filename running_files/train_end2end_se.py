...
save_path = './checkpoint_se/'+'end2end-SE-100-'+str(opt.seg_model)+'-'+str(opt.loss_lambda)+'-'+time.strftime("%Y%m%d-%H%M%S")
...
logger = wandb.init(project='end2end-SE', name=str(opt.seg_model)+"-100-"+str(opt.loss_lambda), resume='allow', anonymous='must')
