...
save_path = './checkpoint_cell/'+'UNet_cell-100-'+time.strftime("%Y%m%d-%H%M%S")
...
logger = wandb.init(project='vanilla-unet', name="unet-cell-100", resume='allow', anonymous='must')
