...
logger = wandb.init(project='ISIC_ablation', name="unet-200-"+str(opt.aug_type), resume='allow', anonymous='must')
...
while total_iters < opt.n_epochs:
    for i, batch in enumerate(train_loader):
        ...
        loss_fake += jaccard_index_loss(torch.sigmoid(masks_pred.squeeze()), fake_mask.float().squeeze())
