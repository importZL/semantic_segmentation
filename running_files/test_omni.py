...
##### prepare dataloader #####
dataset = BasicDataset('/home/li/workspace/data/omnipose-worm/worm_test', train=False)
print('test number: '+str(len(dataset)))
...
model_score = evaluate(net, test_loader, device, opt.amp)
