...
save_path = './checkpoint_cell/'+'end2end-cell-100-'+str(opt.seg_model)+'-'+str(opt.loss_lambda)+'-'+time.strftime("%Y%m%d-%H%M%S")
...
logger = wandb.init(project='end2end-Cell', name=str(opt.seg_model)+"-100-"+str(opt.loss_lambda), resume='allow', anonymous='must')
...
model_path = '/home/li/workspace/semantic_segmentation/pix2pix_JSRT_model/20230404-055810-pix2pix-Cell-100'
